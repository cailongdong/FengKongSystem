...
public class IndInfo {
  ...
  private String riskinclination;
  ...
  public String getRiskinclination() {
    return riskinclination;
  }

  public void setRiskinclination(String riskinclination) {
    this.riskinclination = riskinclination;
  }
