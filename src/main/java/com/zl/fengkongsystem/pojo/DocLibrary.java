...
public class DocLibrary {
  ...
  public String getDocorganizer() {
    return docorganizer;
  }

  public void setDocorganizer(String docorganizer) {
    this.docorganizer = docorganizer;
  }


  public String getDocsecret() {
    return docsecret;
  }

  public void setDocsecret(String docsecret) {
    this.docsecret = docsecret;
  }
