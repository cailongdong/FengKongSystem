...
public class CostInfo {
  ...
  public String getOccurdirection() {
    return occurdirection;
  }

  public void setOccurdirection(String occurdirection) {
  ...
  public void setRatiosum(Double ratiosum) {
  ...
  public Double getRiskagentsum() {
    return riskagentsum;
  }

  public void setRiskagentsum(Double riskagentsum) {
    this.riskagentsum = riskagentsum;
  }
