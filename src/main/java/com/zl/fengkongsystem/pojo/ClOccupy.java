...
public class ClOccupy {
  ...
  public String getRelativedivno() {
    return relativedivno;
  }

  public void setRelativedivno(String relativedivno) {
    this.relativedivno = relativedivno;
  }
