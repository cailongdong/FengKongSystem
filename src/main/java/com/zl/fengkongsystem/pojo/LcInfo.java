...
public class LcInfo {
  ...
  public void setFreightbilltype(String freightbilltype) {
    this.freightbilltype = freightbilltype;
  }


  public String getImportcargo() {
    return importcargo;
  }

  public void setImportcargo(String importcargo) {
  ...
  public void setInformbank(String informbank) {
    this.informbank = informbank;
  }
  ...
  public Double getLcsum() {
    return lcsum;
  }

  public void setLcsum(Double lcsum) {
    this.lcsum = lcsum;
  }


  public String getLcterm() {
    return lcterm;
  }

  public void setLcterm(String lcterm) {
    this.lcterm = lcterm;
  }
