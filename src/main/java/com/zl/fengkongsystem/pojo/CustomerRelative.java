...
public class CustomerRelative {
  ...
  public String getEngageterm() {
    return engageterm;
  }

  public void setEngageterm(String engageterm) {
  ...
  public Double getOughtsum() {
    return oughtsum;
  }

  public void setOughtsum(Double oughtsum) {
